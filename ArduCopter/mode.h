...
//Start Add New Mode Spiral TD
class ModeSpiralTD : public Mode {
...
protected:
    ...
    const char *name() const override { return "SPIRALTD"; }
    const char *name4() const override { return "SPTD"; }
