...
#define AC_SPIRAL_RADIUS_DEFAULT    1000.0f     // radius of the circle in cm that the vehicle will fly
#define AC_SPIRAL_RATE_DEFAULT      20.0f       // turn rate in deg/sec.  Positive to turn clockwise, negative for counter clockwise
#define AC_SPIRAL_ANGULAR_ACCEL_MIN 2.0f        // angular acceleration should never be less than 2deg/sec
#define AC_SPIRAL_SDIRECTION_DEFAULT 1           // DIRECTION of SPIRAL
#define AC_SPIRAL_SPITCH_DEFAULT     5               // PITCH of SPIRAL
...
public:
    ...
    /// Constructor
    AC_Spiral(const AP_InertialNav& inav, const AP_AHRS_View& ahrs, AC_PosControl& pos_control);
...
private:
    ...
    AP_Float    _sdirection;          // rotation speed in deg/sec
    AP_Float    _spitch;          // rotation speed in deg/sec
